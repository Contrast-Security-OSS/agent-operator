...
public class ClusterNamespaceLabelTests : IClassFixture<TestingContext>
{
    private const string ScenarioName = "injection-namespacelabel";

    private readonly TestingContext _context;

    public ClusterNamespaceLabelTests(TestingContext context, ITestOutputHelper outputHelper)
    {
        _context = context;
    ...
    {
        var client = await _context.GetClient(defaultNamespace: "testing-namespacelabel");
